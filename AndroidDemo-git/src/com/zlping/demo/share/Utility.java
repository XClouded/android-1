...
public class Utility {
    ...
    public static void setHeader(String httpMethod, HttpUriRequest request,
            WeiboParameters authParam, String url, String token,String appKey,String appSecret){
        mRequestHeader.add("Accept-Encoding", "gzip");
        ...
        if (!isBundleEmpty(authParam)) {
            String authHeader = getWeiboAuthHeader(token);
            if (authHeader != null) {
    ...
    public static String getWeiboAuthHeader(String token){
        if(token == null){
            return null;
        }
        return "OAuth2 " + token;
    ...
    public static String openUrl(Context context, String url, String method,
            WeiboParameters params, String token){
        String rlt = "";
        String file = "";
    ...
    public static String openUrl(Context context, String url, String method,WeiboParameters params, String file, String token){
        String result = "";
        try {
            ...
            setHeader(method, request, params, url, token,"360420510","78a5ca483adc5ed3de89993694a6965e");
