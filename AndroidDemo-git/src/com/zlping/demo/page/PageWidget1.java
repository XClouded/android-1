...
public class PageWidget1 extends FrameLayout {
	...
	public PageWidget1(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public PageWidget1(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		mContext = context;
		viewInit();
	...
	private class FingerTouchListener implements OnTouchListener {
		...
		public boolean onTouch(View v, MotionEvent event) {
			...
			if (v == PageWidget1.this && mAdapter != null) {
				if (event.getAction() == MotionEvent.ACTION_DOWN) {
					...
					mTouch.x = event.getX();
					mTouch.y = event.getY();
					PageWidget1.this.postInvalidate();
