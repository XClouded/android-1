package com.fanqie.menu.ui.anim.page;
...
public class PageWidget extends View {
    ...
    private boolean mIsDownEvent = true;
    ...
    public boolean doTouchEvent(MotionEvent event) {
        ...
        if (event.getAction() == MotionEvent.ACTION_UP) {
            Log.d("PageWidget", "event.getX()==down_x:"+event.getX()+"|"+down_x+"||"+(event.getX()<=down_x+1&&event.getX()>=down_x-1));
...
*/
    ...
    protected void onDraw(Canvas canvas) {
        if(mCurPageBitmap!=null&&mIsDownEvent){
            canvas.drawBitmap(mCurPageBitmap, 0, 0, null);
        }else if(mCurPageBitmap!=null&&!mIsDownEvent){
            calcPoints();
